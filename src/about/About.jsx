          ...
          <div className="flex flex-wrap gap-3">
            {tabs.map(tab => (
              <button
                ...
                className={`px-4 py-2 rounded-lg ${activeTab === tab.id ? 'bg-primary text-white px-8' : 'bg-gray-200 text-gray-800 px-8'
                  }`}
              >
                {tab.label}
              </button>
